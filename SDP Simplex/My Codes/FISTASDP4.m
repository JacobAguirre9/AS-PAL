function [y,u,iter,fistaFailure,L]=FISTASDP4(x0,mu,L0,chi,beta,sigma,maxiterFISTA,lambda,pen,pold,w,psi_s,grad_psi_s,prox_psi_n,params,last)
iter=0;
x=x0;
y=x0;
A=0;
...
for j=1:maxiterFISTA
    ...
    y=prox_psi_n(xtilde-(1/L)*storegradient);
    iter=iter+1;
