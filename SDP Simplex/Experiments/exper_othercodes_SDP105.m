...
hparam_arr = {rqp_aipp_hparam, iapial_hparam, ialm_hparam};
name_arr = {'RQP', 'IPL', 'iALM'};
framework_arr = {@penalty3, @IAIPAL3, @iALM3};
...
filename='105SDP20instances_experiments.xlsx';
